define('app',["exports", "aurelia-framework", "aurelia-event-aggregator", "@material/top-app-bar", "@material/drawer", "@material/slider", "@material/tab-bar"], function (_exports, _aureliaFramework, _aureliaEventAggregator, _topAppBar, _drawer, _slider, _tabBar) {
  "use strict";
  ...
  var App = (_dec = (0, _aureliaFramework.inject)(_aureliaEventAggregator.EventAggregator), _dec(_class = /*#__PURE__*/function () {
    ...
    _proto.attached = function attached() {
      ...
      this.slider = new _slider.MDCSlider(this.slider);
      this.sliderDisabled = new _slider.MDCSlider(this.sliderDisabled);
      this.sliderDiscrete = new _slider.MDCSlider(this.sliderDiscrete);
      this.sliderDiscreteDisabled = new _slider.MDCSlider(this.sliderDiscreteDisabled);
      this.slidertick = new _slider.MDCSlider(this.sliderTick);
      this.slidertickDisabled = new _slider.MDCSlider(this.sliderTickDisabled);
      this.tabBar = new _tabBar.MDCTabBar(document.querySelector('.mdc-tab-bar'));
...
define('resources/components/details/details',["exports", "aurelia-framework"], function (_exports, _aureliaFramework) {
  ...
  var DetailsIe = (_dec = (0, _aureliaFramework.customAttribute)('details-ie'), _dec2 = (0, _aureliaFramework.inject)(Element), _dec(_class = _dec2(_class = /*#__PURE__*/function () {
